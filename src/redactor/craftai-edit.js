    ...
    $R.add('plugin', 'craftai-edit',
        {
            ...
            start: function ()
            {
                this.button = this.toolbar.addButton('craftai-edit', {
                    title: 'Edit text with AI',
                    api: 'plugin.craftai-edit.execute'
                });
            ...
            execute: function ()
            {
                ...
                const input = this.app.selection.getText();
                const instructions = prompt('Enter instructions');

                Craft.sendActionRequest('post', 'ai/text/edit', {
                    headers: {
